    ...
    },
    {
      ...
      body: (
        <React.Fragment>
          ...
          <p className="pt-2 pb-3 text-sm text-gray-500 leading-6">Don't save it anywhere others can find it, or on a website you do not trust. Anybody with your Secret Key will have access to your data.</p>
        </React.Fragment>
      ),
    },
    {
      ...
      <React.Fragment>
        ...
        <ul className="mt-7 border-t border-b border-gray-200 divide-y divide-gray-200">
          ...
          <li className="py-4 flex justify-start items-center">
            ...
            <div className="ml-3 flex-grow flex-shrink">
              <p className="text-sm text-gray-500 text-left">{appName} won't be able to see, access, or modify your content</p>
            </div>
          </li>
        </ul>
        <div className="pt-5">
  ...
  const renderYourView = () => {
    const content = (
      <React.Fragment>
        ...
        <p className="mt-3 text-sm text-gray-500 leading-6">These 24 words below are your Secret Key. They're used to access your account. You sign in on different devices with them. Make sure to save them somewhere safe. If you lose these words, you'll lose your account.</p>
  ...
  const renderSaveView = () => {
    const content = (
      <React.Fragment>
        ...
        <p className="mt-3 text-sm text-gray-500 leading-6">Only you know your Secret Key. If you lose it, it'll be lost forever. So save it somewhere you won't forget.</p>
        <div className="pt-6">
